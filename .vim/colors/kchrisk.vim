...
"
" To use a black background, :let g:kchrisk_black_background = 1
...
" not yeat done in GUI 
    ...
    if ! g:kchrisk_black_background
        exec "hi Normal         cterm=NONE   ctermfg=" . <SID>X(85) . " ctermbg= NONE"
    else
        exec "hi Normal         cterm=NONE   ctermfg=" . <SID>X(85) . " ctermbg= ". <SID>X(0) 
    endif
